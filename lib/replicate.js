...
export const STYLE_PROMPTS = {
  gothic: {
    label: 'Gothic Art',
    emoji: '🖤',
    prompt: `Medieval Gothic altarpiece painting — the animal rendered in the devotional manner of a 14th-century Flemish or Sienese master: gold leaf background with intricate punched tooling and raised gesso halos, deep jewel tones of ultramarine lapis lazuli, burgundy lake, and forest viridian heightened with gilded hatching, angular precise drapery with elegant Gothic folds, pointed arch and tracery frame echoing a cathedral triptych, solemn hieratic expression with large expressive eyes, fine cross-hatched ink underdrawing visible in shadow areas, craquelure of aged tempera on oak panel; if any limbs are visible they must be the animal's natural paws, claws, or hooves — never human hands.`,
    negative: `modern, realistic, photorealistic, cartoon, anime, blurry, watermark, cheerful, bright, human hands, human fingers`,
  },
  naiveart: {
    label: 'Naive Art',
    emoji: '🎨',
