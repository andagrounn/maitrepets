...
export const STYLE_PROMPTS = {
  ...
  davinci: {
    ...
    emoji: '🎨',
    prompt: `Portrait painted in the unmistakable style of Leonardo da Vinci — delicate sfumato technique with imperceptible transitions between light and shadow, subtle three-quarter pose against a misty atmospheric landscape receding into a hazy blue-grey distance, warm ochre and umber undertones with soft golden light on the face, exquisite detail in the eyes with a calm enigmatic expression, smooth luminous skin with refined anatomical precision, craquelure texture of aged tempera on wood panel, full portrait composition.`,
    negative: `modern, cartoon, anime, flat, harsh lines, blurry, watermark, photorealistic, garish colors`,
  },
  romanticism: {
    label: 'Romanticism',
    emoji: '🌹',
