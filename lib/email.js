    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px">
        ...
        <tr><td style="background:linear-gradient(135deg,#4f1d96 0%,#7c3aed 45%,#db2777 100%);border-radius:16px 16px 0 0;padding:36px 36px 32px;text-align:center">
          <div style="display:inline-block;width:56px;height:56px;background:rgba(255,255,255,0.15);border-radius:50%;line-height:56px;margin-bottom:16px;text-align:center">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;vertical-align:middle">
              <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C12.83 22 13.5 21.33 13.5 20.5C13.5 20.11 13.35 19.76 13.11 19.49C12.88 19.23 12.74 18.88 12.74 18.5C12.74 17.67 13.41 17 14.24 17H16C18.76 17 21 14.76 21 12C21 6.48 16.52 2 12 2Z" fill="white"/>
              <circle cx="6.5" cy="11.5" r="1.5" fill="rgba(124,58,237,0.8)"/>
              <circle cx="9.5" cy="7.5" r="1.5" fill="rgba(124,58,237,0.8)"/>
              <circle cx="14.5" cy="7.5" r="1.5" fill="rgba(124,58,237,0.8)"/>
              <circle cx="17.5" cy="11.5" r="1.5" fill="rgba(124,58,237,0.8)"/>
            </svg>
          </div>
        ...
        <tr><td style="background:#1a1028;padding:28px 36px 0;text-align:center;border-left:1px solid rgba(124,58,237,0.2);border-right:1px solid rgba(124,58,237,0.2)">
          ...
          <p style="color:#9ca3af;font-size:14px;line-height:1.6;margin:0 0 28px">We're turning your pet into a timeless work of art. Your portrait will be printed on premium enhanced matte paper and shipped within <strong style="color:#c4b5fd">3–7 business days</strong>.</p>
        </td></tr>
            ...
            <tr><td style="padding:20px 22px">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td style="color:#9ca3af;font-size:13px;padding:4px 0">Your portrait is printed on premium matte paper &amp; framed</td>
                </tr>
                <tr>
                  <td width="28" valign="top" style="padding:4px 10px 4px 0">
