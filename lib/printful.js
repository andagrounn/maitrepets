...
// ─── Product Variants ──────────────────────────────────────────────────────────
// Main product: Enhanced Matte Paper Framed Poster (in) — Product ID 2
// Variant IDs verified live from Printful catalog API.
// TODO: Replace variantId: 0 placeholders for brown/white with real Printful variant IDs.
...
const VARIANTS_BROWN = {
  'poster-8x10':  { variantId: 0, name: '8×10" Framed Matte Poster (Walnut Brown)',  price: 49.99 },
  'poster-11x14': { variantId: 0, name: '11×14" Framed Matte Poster (Walnut Brown)', price: 59.99 },
  'poster-12x16': { variantId: 0, name: '12×16" Framed Matte Poster (Walnut Brown)', price: 64.99 },
  'poster-16x20': { variantId: 0, name: '16×20" Framed Matte Poster (Walnut Brown)', price: 79.99 },
  'poster-18x24': { variantId: 0, name: '18×24" Framed Matte Poster (Walnut Brown)', price: 99.99 },
  'poster-24x36': { variantId: 0, name: '24×36" Framed Matte Poster (Walnut Brown)', price: 139.99 },
};

const VARIANTS_WHITE = {
  'poster-8x10':  { variantId: 0, name: '8×10" Framed Matte Poster (White)',  price: 49.99 },
  'poster-11x14': { variantId: 0, name: '11×14" Framed Matte Poster (White)', price: 59.99 },
  'poster-12x16': { variantId: 0, name: '12×16" Framed Matte Poster (White)', price: 64.99 },
  'poster-16x20': { variantId: 0, name: '16×20" Framed Matte Poster (White)', price: 79.99 },
  'poster-18x24': { variantId: 0, name: '18×24" Framed Matte Poster (White)', price: 99.99 },
  'poster-24x36': { variantId: 0, name: '24×36" Framed Matte Poster (White)', price: 139.99 },
};
