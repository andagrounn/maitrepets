...
// Paper-only prints: Enhanced Matte Paper Poster (in) — Product ID 1, unframed
// Used for quick paper print orders (printer icon) and Extra Print Copy addon.
export const EXTRA_COPY_VARIANTS = {
  'poster-8x10':  { variantId: 4463,  name: '8×10" Enhanced Matte Poster (unframed)'  },
  'poster-11x14': { variantId: 14125, name: '11×14" Enhanced Matte Poster (unframed)' },
  'poster-12x16': { variantId: 1349,  name: '12×16" Enhanced Matte Poster (unframed)' },
  'poster-16x20': { variantId: 3877,  name: '16×20" Enhanced Matte Poster (unframed)' },
  'poster-18x24': { variantId: 1,     name: '18×24" Enhanced Matte Poster (unframed)' },
  'poster-24x36': { variantId: 2,     name: '24×36" Enhanced Matte Poster (unframed)' },
};
