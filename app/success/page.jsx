          ...
          <>
            ...
            <div className="flex flex-col gap-2 mb-6">
              {[
                ...
                { icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>, title: 'Delivered in 7–14 business days', color: 'bg-green-100 text-green-700' },
              ].map((t) => (
                <div key={t.title} className={`flex items-center gap-2 ${t.color} rounded-xl px-4 py-2.5 text-sm font-semibold w-full`}>
                  {t.icon}
                  {t.title}
                </div>
              ))}
