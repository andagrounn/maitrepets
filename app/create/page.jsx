          ...
          {generatedUrl && !isLoading && (
            <div className="grid lg:grid-cols-5 gap-8">
              ...
              <div className="md:col-span-3 space-y-4">
                ...
                {/* Share buttons */}
                {generatedUrl && imageRevealed && (
                  <div>
                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Share your portrait</p>
                    <div className="flex gap-2 flex-wrap">
                      {/* X / Twitter */}
                      <a
                        href={`https://x.com/intent/tweet?text=${encodeURIComponent('Just turned my pet into a masterpiece with AI 🎨 Check out @maitrepets!')}&url=${encodeURIComponent('https://maitrepets.com')}`}
                      ...
                      {/* Facebook */}
                      <a
                        href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://maitrepets.com')}`}
                        target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-[#1877f2] text-white hover:bg-[#166fe5] transition-all">
                      ...
                      {/* Instagram — can't deep-link, open profile */}
                      <a
                        href="https://instagram.com/maitrepets"
                        target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-white hover:opacity-90 transition-all"
                      ...
                      {/* TikTok */}
                      <a
                        href="https://tiktok.com/@maitrepets"
                        target="_blank" rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-black text-white hover:bg-gray-900 transition-all border border-gray-700">
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                <p className="text-xs text-gray-400 text-center flex items-center justify-center gap-1.5">
                  ...
                  Secure checkout by PayPal · No hidden fees
                </p>
              </div>
            </div>
          )}
